...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(LibraryServiceManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroserviceException(LibraryServiceManagerException exception){
