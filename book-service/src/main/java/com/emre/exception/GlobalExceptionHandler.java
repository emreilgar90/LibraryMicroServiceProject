...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BookServiceManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroserviceException(BookServiceManagerException exception){
